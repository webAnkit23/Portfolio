  ...
  return (
    ...
    <a href='/'>
     <div className='flex w-auto gap-5 p-5 rounded shadow bg-slate-100'>
        <div className='w-[40px] h-[40px] flex items-center justify-center shadow  rounded-full'>
          <MdOutlineLocationOn className='hover:text-blue-500' size={25} />
        </div>
       
        <div >
            <h3 className='font-semibold text-blue-500 '>Location</h3>
            <p className='font-normal text-gray-500 cursor-pointer hover:text-blue-700'>Gorakhpur,India</p>
        </div>
     </div>
     </a>
     ...
     <div className='flex w-auto gap-5 p-5 rounded shadow bg-slate-100'>
        ...
        <div >
            ...
            <p className='font-normal text-gray-500 cursor-pointer hover:text-blue-700'>Ankit Singh</p>
        </div>
     </div>
     </a>
     <a>
     <div className='flex w-auto gap-5 p-5 rounded shadow bg-slate-100'>
        ...
        <div >
            ...
            <p className='font-normal text-gray-500 cursor-pointer hover:text-blue-700'>Ankit Singh_x0</p>
        </div>
     </div>
     </a>
     <a>
     <div className='flex w-auto gap-5 p-5 rounded shadow bg-slate-100'>
        ...
        <div >
            ...
            <p className='font-normal text-gray-500 cursor-pointer hover:text-blue-700'>www.ankitsingh2323@gmail.com</p>
        </div>
     </div>
     </a>
     </div>
