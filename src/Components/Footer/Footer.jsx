...
export default function Footer() {
  return (
    <div className=" relative flex items-center justify-around text-white h-[100px] bg-black container-full ">
      ...
      <div  className='fixed flex flex-col items-center justify-center  cursor-pointer bottom-[10px]  right-2'>
        <FaLocationArrow onClick={() =>{
            window.scrollTo({top:'0px' ,behavior:'smooth'})
        }} className=' rotate-[-46deg] duration-150 text-blue-500  ' size={40}/>
      </div>
      </div>
    </div>
