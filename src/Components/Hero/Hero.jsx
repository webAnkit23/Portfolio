  ...
  return (
    <div id='home' className="flex mt-[100px] flex-col justify-between gap-5 p-10  container-fill lg:flex-row-reverse lg:items-center lg:justify-center lg:gap-20">
        ...
        <div className="flex flex-col items-center text-center lg:text-left lg:items-start">
            <div  className="textAnimate font-bold sm:text-[60px] leading-tight text-[44px] lg:w-[550px]">Mern Stack
            ...
            <p className='typing mt-2 text-lg text-gray-800 max-w-[480px] ' style={{fontFamily:'math'}}>Hi , I'm Ankit Singh . A passionate Web Developer based in Gorakhpur , India .</p>
